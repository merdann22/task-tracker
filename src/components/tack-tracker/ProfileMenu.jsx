    ...
    return (
        <div className="relative">
            <button
                ...
                className="text-white px-2 rounded flex items-center justify-center"
            >
                ...
                {open && (
                    <svg width="24" height="24" transform="rotate(180)"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_2_9)">
                            <path d="M7.415 8.20999L12 12.795L16.585 8.20999L18 9.62499L12 15.625L6 9.62499L7.415 8.20999Z" fill="white"/>
                        </g>
                        <defs>
            ...
            {open && (
                <div className="relative">
                    <svg className="absolute left-1/4 top-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="7.7782" width="11" height="11" transform="rotate(45 7.7782 0)" fill="white"/>
                    </svg>
                    <div className="absolute flex flex-col top-2 mt-2 w-32 right-0 bg-white border rounded shadow">
                        ...
                        <Link to="/" className="p-2 hover:bg-gray-100 cursor-pointer">
                            Log Out
                        </Link>
                    </div>
                </div>
