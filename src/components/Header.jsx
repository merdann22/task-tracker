...
export default function Header() {
    return (
        <div className="lg:bg-[#0067A3] m-auto w-full">
            <div className="flex items-center p-5 justify-between w-full max-w-[1235px] mx-auto">
                <Link to="/"><h1 className="text-2xl text-white hidden lg:block">Awesome Kanban Board</h1></Link>
                <div className="">
